...
TOOL_NAME=${TOOL_NAME:-pact_mock_server_cli}
...
if [[ $TOOL_NAME == 'pact_mock_server_cli' ]]; then
  ...
  homepage="https://github.com/pact-foundation/pruby-standalone/README.md"
  location="https://github.com/pact-foundation/ruby-standalone"
  license="MIT"
  bin=pact\\\\bin\\\\pact-plugin-cli.exe\",\"pact\\\\bin\\\\pactflow.bat
  # bin="pact\\bin\\pact-plugin-cli.exe","pact\\bin\\pact-broker.bat","pact\\bin\\pact-stub-service.bat","pact\\bin\\pact-message.bat","pact\\bin\\pact-provider-verifier.bat","pact\\bin\\pact.bat","pact\\bin\\pact-mock-service.bat","pact\\bin\\pact-publish.bat","pact\\bin\\pactflow.bat"
  ...
  if [[ $macos_arm64 || $macos_x64 || $linux_arm64 || $linux_x64 || $windows_arm64 || $windows_x64 || $windows_x86 ]]; then
    ...
    if [[ $macos_arm64 || $macos_x64 ]]; then
      if [[ $macos_arm64 ]]; then
        ...
        macos_arm64_url="https://github.com/pact-foundation/pact-reference/releases/download/$tag/$macos_arm64"
        echo "👮‍♀️ Checksum SHA256:\t $macos_arm64_shashum"
      fi
      if [[ $macos_x64 ]]; then
        download_and_checksum $macos_x64
        macos_x64_shashum=${shasignature[1]}
        macos_x64_url="https://github.com/pact-foundation/pact-reference/releases/download/$tag/$macos_x64"
    ...
    if [[ $linux_arm64 || $linux_x64 ]]; then
      if [[ $linux_arm64 ]]; then
        ...
        linux_arm64_url="https://github.com/pact-foundation/pact-reference/releases/download/$tag/$linux_arm64"
        echo "👮‍♀️ Checksum SHA256:\t $linux_arm64_shashum"
      fi
      if [[ $linux_x64 ]]; then
        download_and_checksum $linux_x64
        linux_x64_shashum=${shasignature[1]}
        linux_x64_url="https://github.com/pact-foundation/pact-reference/releases/download/$tag/$linux_x64"
    ...
    if [[ $windows_arm64 || $windows_x64 || $windows_x86 ]]; then
      if [[ $windows_arm64 ]]; then
        ...
        windows_arm64_url="https://github.com/pact-foundation/pact-reference/releases/download/$tag/$windows_arm64"
        echo "👮‍♀️ Checksum SHA256:\t $windows_arm64_shashum"
      fi
      if [[ $windows_x64 ]]; then
        download_and_checksum $windows_x64
        windows_x64_shashum=${shasignature[1]}
        windows_x64_url="https://github.com/pact-foundation/pact-reference/releases/download/$tag/$windows_x64"
      ...
      echo "windows_x86: $windows_x86"
        ...
        windows_x86_url="https://github.com/pact-foundation/pact-reference/releases/download/$tag/$windows_x86"
